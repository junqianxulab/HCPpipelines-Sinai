...
MaskStyle=`opts_GetOpt1 "--maskstyle" $@` # set '--maskstyle=preFS' to use preFS mask rather than default brainmask_fs generated by FreeSurfer2CaretConvertAndRegisterNonlinear.sh, useful if having skullstrip issues
